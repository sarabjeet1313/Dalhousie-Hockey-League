...
public class LeagueTest {
	...
	Player player1 = new Player("Player1", "Forward", false, 1, 1, 1, 1, 1, false, 0);
	Player player2 = new Player("Player2", "Forward", false, 1, 1, 1, 1, 1, false, 0);
	Player player3 = new Player("Player3", "defence", false, 1, 1, 1, 1, 1, false, 0);
	Player player4 = new Player("Player4", "Goalie", false, 1, 1, 1, 1, 1, false, 0);
