...
public class LeagueObjectTestData {
	...
	Player agent2 = teamManagement.PlayerWithParameters("Agent5", "goalie", false, 1, 1, 1, 1, 1, false, false, 0, false);
	...
	Player agent6 = teamManagement.PlayerWithParameters("Agent9", "forward", false, 1, 1, 1, 1, 1, false, false, 0, false);
	Player agent7 = teamManagement.PlayerWithParameters("Agent10", "forward", true, 1, 1, 1, 1, 1, false, false, 0, false);
	...
	Player agent12 = teamManagement.PlayerWithParameters("Agent15", "defense", false, 1, 1, 1, 1, 1, false, false, 0, false);
