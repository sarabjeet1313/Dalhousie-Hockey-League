...
public class PlayerTest {
	...
	public void getPlayerStrengthThreeTest() {
		Player player = teamManagement.PlayerWithParameters("Player1", "Forward", false, 1, 1, 1, 1, 1, true, false, 0);
		double strength = playerInfo.getPlayerStrength(player);
	...
	public void getPlayerStrengthFourTest() {
		Player player = teamManagement.PlayerWithParameters("Player1", "Defense", false, 1, 1, 2, 1, 1, true, false, 0);
		double strength = playerInfo.getPlayerStrength(player);
