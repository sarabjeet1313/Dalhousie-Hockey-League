...
public class LeagueMockData implements ILeaguePersistance {
	...
	private Player player1 = teamManagement.PlayerWithParameters("Player One", "forward", true, 49, 1, 1, 1, 1, false, false, 0);
	private Player player2 = teamManagement.PlayerWithParameters("Player Two", "defense", false, 51, 1, 1, 1, 1, false, true, 0);
	private Player player3 = teamManagement.PlayerWithParameters("Player Three", "goalie", false, 1, 1, 1, 1, 1, false, false, 0);
	private Player player4 = teamManagement.PlayerWithParameters("Agent1", "forward", false, 1, 1, 1, 1, 1, false, false, 0);
	private Player player5 = teamManagement.PlayerWithParameters("Agent2", "defense", false, 51, 1, 1, 1, 1, false, true, 0);
	private Player player6 = teamManagement.PlayerWithParameters("Agent3", "defense", false, 1, 1, 1, 1, 1, false, false, 0);
	Player agent1 = teamManagement.PlayerWithParameters("Agent4", "forward", true, 1, 1, 1, 1, 1, false, false, 0);
	Player agent2 = teamManagement.PlayerWithParameters("Agent5", "goalie", false, 50, 1, 1, 1, 1, false, false, 0);
	Player agent3 = teamManagement.PlayerWithParameters("Agent6", "forward", false, 1, 1, 1, 1, 1, false, false, 0);
	Player agent4 = teamManagement.PlayerWithParameters("Agent7", "forward", false, 1, 1, 1, 1, 1, false, false, 0);
	Player agent5 = teamManagement.PlayerWithParameters("Agent8", "defense", false, 1, 1, 1, 1, 1, false, false, 0);
	Player agent6 = teamManagement.PlayerWithParameters("Agent9", "forward", false, 48, 1, 1, 1, 1, false, false, 0);
	Player agent7 = teamManagement.PlayerWithParameters("Agent10", "forward", true, 51, 1, 1, 1, 1, false, false, 0);
	Player agent8 = teamManagement.PlayerWithParameters("Agent11", "defense", false, 1, 1, 1, 1, 1, false, false, 0);
	Player agent9 = teamManagement.PlayerWithParameters("Agent12", "goalie", false, 1, 1, 1, 1, 1, false, false, 0);
	Player agent10 = teamManagement.PlayerWithParameters("Agent13", "forward", false, 1, 1, 1, 1, 1, false, false, 0);
	Player agent11 = teamManagement.PlayerWithParameters("Agent14", "defense", false, 1, 1, 1, 1, 1, false, false, 0);
	Player agent12 = teamManagement.PlayerWithParameters("Agent15", "defense", false, 49, 1, 1, 1, 1, false, false, 0);
	Player agent13 = teamManagement.PlayerWithParameters("Agent16", "forward", true, 1, 1, 1, 1, 1, false, false, 0);
	Player agent14 = teamManagement.PlayerWithParameters("Agent17", "defense", false, 1, 1, 1, 1, 1, false, false, 0);
	Player agent15 = teamManagement.PlayerWithParameters("Agent18", "forward", false, 1, 1, 1, 1, 1, false, false, 0);
	Player agent16 = teamManagement.PlayerWithParameters("Agent19", "forward", false, 1, 1, 1, 1, 1, false, false, 0);
	Player agent17 = teamManagement.PlayerWithParameters("Agent20", "defense", false, 1, 1, 1, 1, 1, false, false, 0);
	Player agent18 = teamManagement.PlayerWithParameters("Agent21", "defense", false, 1, 1, 1, 1, 1, false, false, 0);
	Player agent19 = teamManagement.PlayerWithParameters("Agent22", "defense", false, 1, 1, 1, 1, 1, false, false, 0);
	Player agent20 = teamManagement.PlayerWithParameters("Agent23", "goalie", false, 1, 1, 1, 1, 1, false, false, 0);
	Player agent21 = teamManagement.PlayerWithParameters("Agent24", "forward", true, 1, 1, 1, 1, 1, false, false, 0);
	Player agent22 = teamManagement.PlayerWithParameters("Agent25", "defense", false, 1, 1, 1, 1, 1, false, false, 0);
	Player agent23 = teamManagement.PlayerWithParameters("Agent26", "goalie", false, 1, 1, 1, 1, 1, false, false, 0);
	Player agent24 = teamManagement.PlayerWithParameters("Agent27", "forward", false, 1, 1, 1, 1, 1, false, false, 0);
	Player agent25 = teamManagement.PlayerWithParameters("Agent28", "defense", false, 1, 1, 1, 1, 1, false, false, 0);
	Player agent26 = teamManagement.PlayerWithParameters("Agent29", "defense", false, 1, 1, 1, 1, 1, false, false, 0);
	Player agent27 = teamManagement.PlayerWithParameters("Agent30", "goalie", false, 1, 1, 1, 1, 1, false, false, 0);
