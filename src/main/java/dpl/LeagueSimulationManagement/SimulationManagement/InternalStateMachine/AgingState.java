...
public class AgingState implements ISimulationState {
	...
	public AgingState(League leagueToSimulate, ISchedule schedule, IStandingsPersistance standingsDb,
	...
	public ISimulationState nextState(InternalStateContext context) {
		if (seasonCalendar.getSeasonOverStatus() | seasonCalendar.isLastDayOfSeason(currentDate)) {
			...
			return new PersistState(leagueToSimulate, schedule, standingsDb, context, seasonCalendar, currentDate,
